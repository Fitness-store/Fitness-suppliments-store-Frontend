    ...
    <section className="py-28 relative overflow-hidden" style={{ background: '#09090b' }}>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto px-6 lg:px-12">
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, #0f0f11 0%, #1a1008 50%, #0f0f11 100%)',
        ...
        >
          ...
          <div
            ...
            style={{ background: 'radial-gradient(ellipse 70% 60% at 50% -10%, rgba(228,185,74,0.15), transparent)' }}
          />
          {/* Corner glows */}
          <div className="absolute -top-20 -left-20 w-60 h-60 rounded-full pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(228,185,74,0.08), transparent)', filter: 'blur(40px)' }} />
          <div className="absolute -bottom-20 -right-20 w-60 h-60 rounded-full pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(249,115,22,0.08), transparent)', filter: 'blur(40px)' }} />

          {/* Decorative ring */}
          <div
            className="absolute -right-32 -top-32 w-96 h-96 rounded-full pointer-events-none"
            style={{ border: '1px solid rgba(228,185,74,0.08)' }}
          />
          <div
            className="absolute -right-16 -top-16 w-64 h-64 rounded-full pointer-events-none"
            style={{ border: '1px solid rgba(228,185,74,0.05)' }}
          />
          ...
          <div className="relative z-10 px-10 py-16 lg:px-20 lg:py-20">
            <div className="max-w-3xl mx-auto text-center">
              ...
              {/* Headline */}
              <h2 className="section-heading text-5xl lg:text-6xl font-black text-white leading-tight mb-6">
                Your First Step to
                <br />
              ...
              <p className="text-zinc-400 text-lg leading-relaxed max-w-xl mx-auto mb-10">
                Use code <strong className="text-white">SMILE</strong> at checkout and get{' '}
              ...
              <div
                ...
                style={{ background: 'rgba(255,255,255,0.04)', border: '1px dashed rgba(228,185,74,0.35)' }}
              >
              ...
              {/* Fine print */}
              <p className="text-zinc-600 text-xs mt-8 tracking-wide">
